...
CUSTOM_HAL_IMGSENSOR = ov13855_mipi_raw ar1335_mipi_raw s5k5e2ya_mipi_raw
CUSTOM_HAL_LENS = lc898212xdaf bu63165af dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = s5k5e2ya_mipi_raw s5k5e8yx_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = lc898214af
...
CUSTOM_HAL_SUB_IMGSENSOR = ar1335_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = ov13855_mipi_raw ar1335_mipi_raw s5k5e2ya_mipi_raw
...
CUSTOM_KERNEL_MAIN_BACKUP_LENS = lc898214af
...
CUSTOM_KERNEL_FLOOR_STEP_COUNTER = no
CUSTOM_KERNEL_STEP_DETECTOR =
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_BACKUP_LENS = ad5820af
CUSTOM_KERNEL_SUB_IMGSENSOR = ar1335_mipi_raw
...
#modify by linyf, change modem img directory to manning_lwg_dsds, IKINDPROO-4
#CUSTOM_MODEM=mt6797_sp_lwctg_mp5_umoly0070_prod mt6797_sp_md3_srlte_v2_c2k0045_prod
CUSTOM_MODEM=manning_lwg_dsds
...
MTK_AGPS_APP = yes
MTK_AIV_SUPPORT = no
#Begin lenovo-sw, wangsq2, 20171205
...
# begin lenovo, xucw, 20160228, INDRIYAPROO-148
#MTK_ANDROID_FOR_WORK_SUPPORT = yes
MTK_ANDROID_FOR_WORK_SUPPORT = no
# end lenovo, xucw, 20160228, INDRIYAPRO-148
...
#BEGIN, Lenovo-sw huangzh3, disable ui support due to related setting abscent, INDRIYAPRO-445
...
MTK_BUILD_VERNO = alps-mp-o0.mp1-V3.33_k97v1.64_P18
MTK_BWC_SUPPORT = yes
#modify by linyf, disable C2K, IKINDPROO-4
#MTK_C2K_LTE_MODE = 2
MTK_C2K_LTE_MODE = 0
MTK_CACHE_MERGE_SUPPORT = no
# Lenovo wuzb1 2017-03-06 INDRIYAPRO-472 Disable MTK vcs calendar import
...
# Begin,Lenovo zhaogf1 2017-12-08  IKINDPROO-220 enable dual camera editor functions
MTK_CAM_IMAGE_REFOCUS_SUPPORT = yes
# End,Lenovo zhaogf1 2017-12-08
...
MTK_CT4GREG_APP = no
#lenovo wangkl3, close this feature.
MTK_CTA_SET = no
MTK_CTA_SUPPORT = no
...
#modify by linyf, enable DYNAMIC_IMS_SWITCH, IKINDPROO-4
...
#lenovo wangkl3, use FileBrowser2 instead of FileManager.
...
#modify by linyf, disable IRAT, IKINDPROO-4
...
MTK_MASS_STORAGE = no
#modify by linyf, MD1 12->9, MD3 2->0, IKINDPROO-4
MTK_MD1_SUPPORT = 9
MTK_MD2_SUPPORT = 4
MTK_MD3_SUPPORT = 0
MTK_MD5_SUPPORT = 5
...
# Lenovo wuzb1 2017-11-29 IKINDPROO-125 Disable MTK in house permission app
...
#BEGIN, Lenovo-sw huangzh3, disable the feature due to abscent, INDRIYAPRO-445
...
#modify by linyf, disable C2K and TDS, IKINDPROO-4
...
# Lenovo wuzb1 2017-02-28 INDRIYAPRO-366 Disable MTK background app manager app
...
MTK_WEEK_NO = W18.09
#modify by linyf, disable wfc support, IKINDPROO-83
MTK_WFC_SUPPORT = no
MTK_WFD_4K_SUPPORT = no
MTK_WFD_HDCP_TX_SUPPORT = no
MTK_WFD_SINK_SUPPORT = no
MTK_WFD_SINK_UIBC_SUPPORT = no
#modify by chencheng6, disable wfd support, IKINDPROO-167
MTK_WFD_SUPPORT = no
...
#[BUILD] added by zhangyuzhou for disable DTBO in OTA begin
MTK_DTBO_FEATURE = no
#[BUILD] added by zhangyuzhou for disable DTBO in OTA end
MNTL_SUPPORT = no
...
#IKINDPROO-425 wuzb1, disable MTK fonts service and app
...
#modify by linyf, disable VIWIFI support, IKINDPROO-83
...
#IKINDPROO-305 wuzb1, disable MTK camera app
...
MTK_EMMC_SUPPORT_OTP_FOR_CUSTOMER = yes
...
# HQ add for countrycode HQ_COUNTRY_CODE_SUPPORT start
HQ_COUNTRY_CODE_SUPPORT=yes
# HQ add for countrycode HQ_COUNTRY_CODE_SUPPORT end
